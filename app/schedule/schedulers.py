...
from app.database.models import CrontabSchedule
from app.database.models import IntervalSchedule
from app.database.models import SolarSchedule
from app.database.models import PeriodicTask
from app.database.models import PeriodicTasks
...
def local_to_utc(dt):
    local = pytz.timezone(app.config['TIMEZONE'])
